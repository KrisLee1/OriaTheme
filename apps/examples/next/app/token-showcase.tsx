...
const fontSizes: readonly TokenSample[] = ["xs", "sm", "md", "lg", "xl", "2xl", "3xl", "4xl", "5xl", "6xl", "7xl", "8xl", "9xl"].map(key => ({ label: key.toUpperCase(), token: `text.${key}`, value: `var(--oria-text-${key})` }));
const lineHeights: readonly TokenSample[] = ["tight", "snug", "normal", "relaxed", "loose"].map(key => ({ label: key, token: `leading.${key}`, value: `var(--oria-leading-${key})` }));
const letterSpacings: readonly TokenSample[] = ["tighter", "tight", "normal", "wide", "wider", "widest"].map(key => ({ label: key, token: `tracking.${key}`, value: `var(--oria-tracking-${key})` }));
...
const radii: readonly TokenSample[] = ["xs", "sm", "md", "lg", "xl", "2xl", "3xl", "4xl"].map(key => ({ label: key.toUpperCase(), token: `--oria-radius-${key}`, value: `var(--oria-radius-${key})` }));
const shadows: readonly TokenSample[] = ["none", "2xs", "xs", "sm", "md", "lg", "xl", "2xl", "inner", "highlight"].map(key => ({ label: key, token: `shadow.${key}`, value: `var(--oria-shadow-${key})` }));
const blurs: readonly TokenSample[] = ["xs", "sm", "md", "lg", "xl", "2xl", "3xl"].map(key => ({ label: key.toUpperCase(), token: `blur.${key}`, value: `var(--oria-blur-${key})` }));
const backdropBlurs: readonly TokenSample[] = ["xs", "sm", "md", "lg", "xl", "2xl", "3xl"].map(key => ({ label: key.toUpperCase(), token: `backdrop.blur.${key}`, value: `var(--oria-backdrop-blur-${key})` }));
...
const durations: readonly TokenSample[] = ["instant", "fast", "normal", "slow"].map(key => ({ label: key, token: `duration.${key}`, value: `var(--oria-duration-${key})` }));
const easings: readonly TokenSample[] = ["standard", "enter", "exit", "emphasized"].map(key => ({ label: key, token: `ease.${key}`, value: `var(--oria-ease-${key})` }));
