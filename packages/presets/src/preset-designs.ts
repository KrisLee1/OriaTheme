...
const unorderedPresetSpecs: readonly PresetSpec[] = [
  ...
  },
  {
    ...
    modes: {
      light: { colors: { background: "#e9eef2", foreground: "#17222b", surface: "#eef4f7", raised: "#f8fbfc", overlay: "#f3f8fa", primary: ["#20aeea", "#149cd5", "#087eaf", "#071a22"], secondary: ["#f7fafb", "#edf3f6", "#dee8ed", "#192832"], muted: ["#e3ebef", "#52646f"], accent: ["#cfeffc", "#16465c"], border: ["#ffffffb8", "#9fb1bd"], input: "#f5f9fb", ring: "#148fc4", selection: ["#b8e8fa", "#103749"], scrim: "#08131bb8", charts: ["#0e748e", "#157872", "#137b5b", "#507705", "#8d5e05", "#a24d15", "#b4256c", "#6c4ec5"] }, tokens: { "gradient.background": { type: "linear", angle: 135, stops: [{ color: "#d6edf7" }, { color: "#eef0f5", position: 52 }, { color: "#e6def3", position: 100 }] }, "gradient.surface": { type: "linear", angle: 135, stops: [{ color: "#ffffffd6" }, { color: "#edf8fc80", position: 55 }, { color: "#ffffffa6", position: 100 }] }, "gradient.accent": { type: "linear", angle: 115, stops: [{ color: "#4ac5ff" }, { color: "#82dcff", position: 58 }, { color: "#a79cf4", position: 100 }] } } },
      dark: { colors: { background: "#090e13", foreground: "#eef6fb", surface: "#111b23", raised: "#17242d", overlay: "#14212a", primary: ["#4ac5ff", "#72d2ff", "#2ab5eb", "#06202c"], secondary: ["#1e2a32", "#26343e", "#30414d", "#eef7fb"], muted: ["#152129", "#aebdc6"], accent: ["#123c50", "#c9efff"], border: ["#ffffff24", "#ffffff4d"], input: "#111b22", ring: "#5bd0ff", selection: ["#155b78", "#f2fbff"], scrim: "#000000d9", charts: ["#7dc7df", "#80cbc3", "#80cdad", "#a3ca75", "#e5b064", "#fba171", "#fb97bd", "#baaefd"] }, tokens: { "gradient.background": { type: "linear", angle: 135, stops: [{ color: "#071923" }, { color: "#0a1119", position: 54 }, { color: "#181126", position: 100 }] }, "gradient.surface": { type: "linear", angle: 135, stops: [{ color: "#31404db3" }, { color: "#172832a6", position: 55 }, { color: "#0f1b24b8", position: 100 }] }, "gradient.accent": { type: "linear", angle: 115, stops: [{ color: "#4ac5ff" }, { color: "#77dcff", position: 58 }, { color: "#9c91f0", position: 100 }] }, "elevation.shadow.xs": [{ x: "0", y: "1px", blur: "4px", spread: "0", color: "#00000033" }, { x: "0", y: "-1px", blur: "0", spread: "0", color: "#ffffff26", inset: true }], "elevation.shadow.sm": [{ x: "0", y: "4px", blur: "12px", spread: "-6px", color: "#00000066" }, { x: "0", y: "1px", blur: "0", spread: "0", color: "#ffffff2e", inset: true }], "elevation.shadow.md": [{ x: "0", y: "14px", blur: "36px", spread: "-16px", color: "#000000a3" }, { x: "0", y: "-1px", blur: "0", spread: "0", color: "#ffffff40" }, { x: "-1px", y: "0", blur: "0", spread: "0", color: "#ffffff2e" }, { x: "0", y: "1px", blur: "0", spread: "0", color: "#00000073" }, { x: "1px", y: "0", blur: "0", spread: "0", color: "#0000005c" }, { x: "0", y: "-10px", blur: "10px", spread: "-5px", color: "#ffffff0d", inset: true }, { x: "0", y: "10px", blur: "10px", spread: "-5px", color: "#ffffff08", inset: true }], "elevation.shadow.lg": [{ x: "0", y: "18px", blur: "42px", spread: "-20px", color: "#000000ad" }, { x: "0", y: "1px", blur: "0", spread: "0", color: "#ffffff33", inset: true }, { x: "0", y: "-12px", blur: "14px", spread: "-7px", color: "#ffffff0d", inset: true }], "elevation.shadow.xl": [{ x: "0", y: "24px", blur: "56px", spread: "-24px", color: "#000000b8" }, { x: "0", y: "1px", blur: "0", spread: "0", color: "#ffffff33", inset: true }], "elevation.shadow.2xl": [{ x: "0", y: "32px", blur: "72px", spread: "-30px", color: "#000000c2" }, { x: "0", y: "1px", blur: "0", spread: "0", color: "#ffffff33", inset: true }], "elevation.shadow.inner": [{ x: "0", y: "-10px", blur: "10px", spread: "-5px", color: "#ffffff0d", inset: true }, { x: "0", y: "10px", blur: "10px", spread: "-5px", color: "#ffffff08", inset: true }], "elevation.shadow.highlight": [{ x: "0", y: "1px", blur: "0", spread: "0", color: "#ffffff40", inset: true }, { x: "-1px", y: "0", blur: "0", spread: "0", color: "#ffffff2e", inset: true }, { x: "0", y: "-1px", blur: "0", spread: "0", color: "#ffffff33", inset: true }, { x: "1px", y: "0", blur: "0", spread: "0", color: "#0000004d", inset: true }, { x: "0", y: "-10px", blur: "10px", spread: "-5px", color: "#ffffff0d", inset: true }, { x: "0", y: "10px", blur: "10px", spread: "-5px", color: "#ffffff08", inset: true }] } }
    }
  },
  {
