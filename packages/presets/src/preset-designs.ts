...
const unorderedPresetSpecs: readonly PresetSpec[] = [
  {
    ...
    tokens: {
      ...
      "radius": "0.625rem", "shadow.sm": [{ x: "0", y: "3px", blur: "10px", spread: "-4px", color: "#0369a126" }],
  ...
  },
  {
    ...
    tokens: {
      "font.sans": humanistSans, "font.display": humanistSans, "leading.relaxed": 1.76, "radius": "0.625rem", "shadow.sm": [{ x: "0", y: "5px", blur: "16px", spread: "-10px", color: "#56747b2b" }], "shadow.md": [{ x: "0", y: "14px", blur: "34px", spread: "-20px", color: "#56747b3d" }],
  ...
  },
  {
    ...
    tokens: {
      ...
      "radius": "0.875rem", "shadow.sm": [{ x: "0", y: "4px", blur: "0", spread: "0", color: "#493c8f38" }], "shadow.md": [{ x: "0", y: "8px", blur: "0", spread: "0", color: "#493c8f4d" }],
  ...
  },
  {
    ...
    tokens: {
      ...
      "radius": "0.5rem", "shadow.sm": [{ x: "0", y: "4px", blur: "12px", spread: "-7px", color: "#51463233" }], "shadow.md": [{ x: "0", y: "14px", blur: "30px", spread: "-18px", color: "#51463245" }],
  ...
  },
  {
    ...
    tokens: {
      "font.sans": roundedSans, "font.display": roundedSans, "font.weight.semibold": "700", "font.weight.bold": "800",
      "radius": "1rem", "shadow.sm": [{ x: "0", y: "7px", blur: "18px", spread: "-10px", color: "#b66f9b3d" }], "shadow.md": [{ x: "0", y: "18px", blur: "40px", spread: "-22px", color: "#9e75b852" }],
  ...
  },
  {
    ...
    tokens: {
      ...
      "radius": "0.625rem", "shadow.sm": [{ x: "0", y: "6px", blur: "18px", spread: "-10px", color: "#c65f493d" }], "shadow.md": [{ x: "0", y: "18px", blur: "42px", spread: "-22px", color: "#a7475c59" }],
  ...
  },
  {
    ...
    tokens: {
      ...
      "radius": "0.5rem", "border.width.hairline": "1px", "border.width.default": "2px", "border.width.strong": "2px", "ring.width": "3px", "ring.offset": "3px",
  ...
  },
  {
    ...
    tokens: {
      ...
      "leading.normal": 1.6, "leading.relaxed": 1.82, "tracking.wide": "0.04em", "radius": "0.625rem", "border.width.hairline": "1px", "border.width.default": "2px", "border.width.strong": "2px", "ring.width": "3px", "ring.offset": "3px",
  ...
  },
  {
    ...
    tokens: {
      "font.sans": roundedSans, "font.display": roundedSans, "font.weight.normal": "500", "font.weight.semibold": "700", "radius": "1.25rem", "border.width.hairline": "1px", "border.width.default": "1px", "border.width.strong": "1px", "ring.width": "3px", "ring.offset": "4px",
      "shadow.sm": [{ x: "0", y: "6px", blur: "12px", spread: "-7px", color: "#a99c9140" }, { x: "5px", y: "5px", blur: "12px", spread: "0", color: "#c9beb452" }, { x: "-6px", y: "-6px", blur: "12px", spread: "0", color: "#ffffffed" }],
      "shadow.md": [{ x: "0", y: "14px", blur: "28px", spread: "-13px", color: "#a99c9145" }, { x: "10px", y: "10px", blur: "22px", spread: "0", color: "#c9beb459" }, { x: "-12px", y: "-12px", blur: "22px", spread: "0", color: "#ffffff" }],
      "shadow.lg": [{ x: "0", y: "24px", blur: "48px", spread: "-20px", color: "#a99c9147" }, { x: "20px", y: "20px", blur: "38px", spread: "0", color: "#c9beb452" }, { x: "-22px", y: "-22px", blur: "38px", spread: "0", color: "#ffffff" }],
      "shadow.inner": [{ x: "0", y: "3px", blur: "7px", spread: "0", color: "#b9ada34d", inset: true }, { x: "4px", y: "4px", blur: "9px", spread: "0", color: "#c9beb459", inset: true }, { x: "-5px", y: "-5px", blur: "9px", spread: "0", color: "#ffffffed", inset: true }],
      "opacity.overlay": 0.9, "duration.normal": "280ms", "ease.standard": [0.18, 0.88, 0.28, 1]
    },
    modes: {
      light: { colors: { background: "#f3f0eb", foreground: "#584842", surface: "#eae4dc", raised: "#fbf9f5", overlay: "#fcfaf7", primary: ["#e9781c", "#d66410", "#bd520c", "#382015"], secondary: ["#f0ebe4", "#e4dcd3", "#d8cec3", "#5a4b43"], muted: ["#e8e2db", "#8b7d75"], accent: ["#f0decc", "#684225"], border: ["#ffffffd9", "#d8cec4"], input: "#f6f2ed", ring: "#e9781c", selection: ["#f4cfaa", "#532f15"], charts: ["#e9781c", "#c96f68", "#789bb6", "#927bb3", "#7f9b73", "#c19358", "#75a0a7", "#b97894"] }, tokens: { "gradient.bg": { type: "radial", position: "top left", stops: [{ color: "#ffffff" }, { color: "#f3f0eb", position: 58 }, { color: "#e7e0d7", position: 100 }] }, "gradient.surface": { type: "linear", angle: 145, stops: [{ color: "#ffffff" }, { color: "#f3eee8", position: 48 }, { color: "#e5ddd4", position: 100 }] }, "gradient.accent": { type: "linear", angle: 135, stops: [{ color: "#f8b06d" }, { color: "#e9781c", position: 100 }] } } },
      dark: { colors: { background: "#28221d", foreground: "#f8f0e7", surface: "#302923", raised: "#3a312a", overlay: "#342c26", primary: ["#f3a362", "#f7b87f", "#de8742", "#3b2010"], secondary: ["#443a32", "#51453a", "#5f5145", "#f8f0e7"], muted: ["#382f29", "#cbbcaf"], accent: ["#553a28", "#f5d6bb"], border: ["#4d4137", "#706154"], input: "#302923", ring: "#f3a362", selection: ["#744728", "#fff3e5"], charts: ["#f3a362", "#df8e88", "#91b6ce", "#ae9acf", "#9ab58e", "#d3ad78", "#91b9bd", "#cd96ac"] }, tokens: { "gradient.bg": { type: "radial", position: "top left", stops: [{ color: "#3c322a" }, { color: "#28221d", position: 70 }] }, "gradient.surface": { type: "linear", angle: 145, stops: [{ color: "#473c33" }, { color: "#302923", position: 100 }] }, "gradient.accent": { type: "linear", angle: 135, stops: [{ color: "#f6b678" }, { color: "#dc7f3b", position: 100 }] }, "shadow.sm": [{ x: "0", y: "6px", blur: "12px", spread: "-7px", color: "#0c0806a6" }, { x: "5px", y: "5px", blur: "12px", spread: "0", color: "#120d0abf" }, { x: "-6px", y: "-6px", blur: "12px", spread: "0", color: "#51453a99" }], "shadow.md": [{ x: "0", y: "14px", blur: "28px", spread: "-13px", color: "#0c0806b3" }, { x: "10px", y: "10px", blur: "22px", spread: "0", color: "#120d0acc" }, { x: "-12px", y: "-12px", blur: "22px", spread: "0", color: "#51453ab3" }], "shadow.lg": [{ x: "0", y: "24px", blur: "48px", spread: "-20px", color: "#0c0806b3" }, { x: "20px", y: "20px", blur: "38px", spread: "0", color: "#120d0acc" }, { x: "-22px", y: "-22px", blur: "38px", spread: "0", color: "#51453aa6" }], "shadow.inner": [{ x: "0", y: "3px", blur: "7px", spread: "0", color: "#120d0aa6", inset: true }, { x: "4px", y: "4px", blur: "9px", spread: "0", color: "#120d0ab3", inset: true }, { x: "-5px", y: "-5px", blur: "9px", spread: "0", color: "#51453a99", inset: true }] } }
    }
  },
  {
    id: "oria-golden-bazaar", name: "Golden Bazaar", category: "visual-style",
    tokens: {
      "font.sans": roundedSans, "font.display": geometricSans, "font.weight.semibold": "700", "font.weight.bold": "800", "tracking.tight": "-0.025em", "radius": "1.125rem", "border.width.hairline": "1px", "border.width.default": "1px", "border.width.strong": "1px", "ring.width": "3px", "ring.offset": "4px",
      "shadow.sm": [{ x: "0", y: "5px", blur: "16px", spread: "-9px", color: "#bb63342e" }, { x: "0", y: "1px", blur: "0", spread: "1px", color: "#ffffffb8", inset: true }],
      "shadow.md": [{ x: "0", y: "16px", blur: "34px", spread: "-18px", color: "#bb633447" }, { x: "0", y: "1px", blur: "0", spread: "1px", color: "#ffffffd9", inset: true }],
      "shadow.lg": [{ x: "0", y: "28px", blur: "58px", spread: "-28px", color: "#bb63345c" }, { x: "0", y: "1px", blur: "0", spread: "1px", color: "#ffffffe6", inset: true }],
      "shadow.highlight": [{ x: "0", y: "1px", blur: "0", spread: "1px", color: "#ffffffcc", inset: true }],
      "opacity.overlay": 0.9, "duration.fast": "160ms", "duration.normal": "260ms", "duration.slow": "420ms", "ease.standard": [0.22, 1, 0.36, 1]
    },
    modes: {
      light: { colors: { background: "#fff0d8", foreground: "#2f241d", surface: "#ffe5b7", raised: "#fffaf2", overlay: "#fff8eb", primary: ["#f4b522", "#df9b12", "#c88209", "#3b2903"], secondary: ["#f06d36", "#db5b28", "#bf491c", "#3b1b10"], muted: ["#f8dfbd", "#765e50"], accent: ["#413896", "#fff8eb"], border: ["#ffffffc7", "#f2cb89"], input: "#fffdf8", ring: "#f4b522", selection: ["#f6c95e", "#3a2805"], charts: ["#f4b522", "#f06d36", "#413896", "#2faa75", "#2786d7", "#de4e79", "#d28b18", "#7984d1"] }, tokens: { "gradient.bg": { type: "radial", position: "top", stops: [{ color: "#fff8d4" }, { color: "#ffd16a", position: 38 }, { color: "#f3a861", position: 74 }, { color: "#ffe7c6", position: 100 }] }, "gradient.surface": { type: "linear", angle: 145, stops: [{ color: "#fffdf9" }, { color: "#fff4e6", position: 100 }] }, "gradient.accent": { type: "linear", angle: 120, stops: [{ color: "#ffd965" }, { color: "#f4b522", position: 52 }, { color: "#ee8b24", position: 100 }] } } },
      dark: { colors: { background: "#2b1c16", foreground: "#fff4df", surface: "#38241c", raised: "#492f23", overlay: "#41291f", primary: ["#ffd66c", "#ffe08e", "#efbd43", "#4a3100"], secondary: ["#ff9566", "#ffad87", "#ed7750", "#43180d"], muted: ["#3a271f", "#d4bdac"], accent: ["#aaa6ff", "#211b59"], border: ["#ffffff24", "#a86d46"], input: "#342119", ring: "#ffda79", selection: ["#704d18", "#fff6dc"], charts: ["#ffd66c", "#ff9566", "#aaa6ff", "#6dd5a0", "#6eb8ff", "#ff8eae", "#e6b75f", "#aab4f5"] }, tokens: { "gradient.bg": { type: "radial", position: "top", stops: [{ color: "#70421d" }, { color: "#422719", position: 46 }, { color: "#2b1c16", position: 100 }] }, "gradient.surface": { type: "linear", angle: 145, stops: [{ color: "#573827" }, { color: "#38241c", position: 100 }] }, "gradient.accent": { type: "linear", angle: 120, stops: [{ color: "#ffe08b" }, { color: "#f8bb45", position: 55 }, { color: "#e98131", position: 100 }] }, "shadow.sm": [{ x: "0", y: "5px", blur: "16px", spread: "-9px", color: "#08040399" }, { x: "0", y: "1px", blur: "0", spread: "1px", color: "#ffffff1f", inset: true }], "shadow.md": [{ x: "0", y: "16px", blur: "34px", spread: "-18px", color: "#080403b3" }, { x: "0", y: "1px", blur: "0", spread: "1px", color: "#ffffff2b", inset: true }], "shadow.lg": [{ x: "0", y: "28px", blur: "58px", spread: "-28px", color: "#080403cc" }, { x: "0", y: "1px", blur: "0", spread: "1px", color: "#ffffff33", inset: true }], "shadow.highlight": [{ x: "0", y: "1px", blur: "0", spread: "1px", color: "#ffffff24", inset: true }] } }
    }
  },
  {
  ...
  },
  {
    ...
    tokens: {
      "font.sans": humanistSans, "font.display": humanistSans,
      "radius": "0.75rem", "border.width.strong": "1px",
  ...
  },
  {
    ...
    tokens: {
      "font.sans": roundedSans, "font.display": roundedSans, "radius": "0.75rem", "shadow.sm": [{ x: "0", y: "6px", blur: "18px", spread: "-10px", color: "#66758f38" }], "shadow.md": [{ x: "0", y: "16px", blur: "38px", spread: "-20px", color: "#66758f4d" }],
  ...
  },
  {
    ...
    tokens: {
      ...
      "radius": "1rem", ...backdropBlurScale(20), "backdrop.saturate": 1.6,
  ...
  },
  {
    ...
    tokens: {
      "font.sans": humanistSans, "font.display": humanistSans,
      "radius": "0.625rem", ...backdropBlurScale(18), "backdrop.saturate": 1.2,
  ...
  },
  {
    ...
    tokens: {
      ...
      "radius": "0.75rem", ...backdropBlurScale(36), "backdrop.saturate": 1.35, "opacity.overlay": 0.82,
  ...
  },
  {
    ...
    tokens: {
      ...
      "radius": "0.5rem", "border.width.hairline": "1px", "border.width.default": "1px", "border.width.strong": "1px",
      ...backdropBlurScale(30), "backdrop.saturate": 1.38, "opacity.overlay": 0.78,
      "shadow.xs": [{ x: "0", y: "1px", blur: "4px", spread: "0", color: "#102c3d0d" }, { x: "0", y: "-1px", blur: "0", spread: "0", color: "#ffffffc7", inset: true }],
      "shadow.sm": [{ x: "0", y: "4px", blur: "12px", spread: "-6px", color: "#102c3d1a" }, { x: "0", y: "1px", blur: "0", spread: "0", color: "#ffffffd1", inset: true }],
      ...
      "shadow.lg": [{ x: "0", y: "18px", blur: "42px", spread: "-20px", color: "#102c3d38" }, { x: "0", y: "1px", blur: "0", spread: "0", color: "#ffffffd9", inset: true }, { x: "0", y: "-12px", blur: "14px", spread: "-7px", color: "#ffffff99", inset: true }],
      "shadow.xl": [{ x: "0", y: "24px", blur: "56px", spread: "-24px", color: "#102c3d42" }, { x: "0", y: "1px", blur: "0", spread: "0", color: "#ffffffd9", inset: true }],
      "shadow.2xl": [{ x: "0", y: "32px", blur: "72px", spread: "-30px", color: "#102c3d4d" }, { x: "0", y: "1px", blur: "0", spread: "0", color: "#ffffffd9", inset: true }],
      "shadow.inner": [{ x: "0", y: "-10px", blur: "10px", spread: "-5px", color: "#ffffff99", inset: true }, { x: "0", y: "10px", blur: "10px", spread: "-5px", color: "#ffffffb3", inset: true }],
      ...
      "duration.fast": "130ms", "duration.normal": "210ms", "duration.slow": "340ms", "ease.standard": [0.2, 0, 0, 1], "ease.emphasized": [0.16, 1, 0.3, 1]
    },
    modes: {
  ...
  },
  {
    ...
    tokens: {
      "font.sans": geometricSans, "font.display": geometricSans,
      "tracking.tight": "-0.03em", "radius": "0.625rem", ...backdropBlurScale(24), "backdrop.saturate": 1.35,
  ...
  },
  {
    ...
    tokens: {
      ...
      "radius": "0.5rem", "shadow.xs": [{ x: "0", y: "1px", blur: "2px", spread: "0", color: "#1d1b201f" }],
  ...
  },
  {
    ...
    tokens: {
      ...
      "radius": "0.75rem", "shadow.sm": [{ x: "0", y: "4px", blur: "14px", spread: "-8px", color: "#24364a2b" }], "shadow.md": [{ x: "0", y: "16px", blur: "38px", spread: "-20px", color: "#24364a40" }],
      "duration.normal": "210ms", "ease.standard": [0.22, 1, 0.36, 1]
    },
    modes: {
