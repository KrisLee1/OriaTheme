...
`@oriatheme/presets` contains 43 complete themes. The default `oriaDefaultTheme` can also be imported directly from `@oriatheme/core`. See [packages and public entry points](packages.md) for the complete package map.
...
| Do this next | Guide |
| --- | --- |
| Use one of the 43 official preset themes, or confirm the required package | [Packages and public entry points: common combinations](packages.md#common-combinations) |
