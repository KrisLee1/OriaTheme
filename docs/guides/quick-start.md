...
`@oriatheme/presets` 提供 36 款完整主题；默认主题 `oriaDefaultTheme` 也可从 `@oriatheme/core` 单独导入。完整包选择见[包与公开入口](packages.md)。
...
| 想立刻完成的事 | 对应指南 |
| --- | --- |
| 使用 36 款官方预设主题，或确认所需 package | [包与公开入口：常见组合](packages.md#常见组合) |
